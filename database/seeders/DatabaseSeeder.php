...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = collect(['members.view', 'members.create', 'members.update', 'members.delete', 'savings.view', 'savings.manage', 'loans.view', 'loans.manage', 'installments.manage', 'reports.view', 'users.manage', 'audit.view']);
        $permissions->each(fn ($name) => Permission::findOrCreate($name, 'web'));
        app(PermissionRegistrar::class)->forgetCachedPermissions();
        $roles = [
            'Super Admin' => $permissions->all(),
            'Admin' => $permissions->except([10])->all(),
            'Bendahara' => ['members.view', 'savings.view', 'savings.manage', 'loans.view', 'loans.manage', 'installments.manage', 'reports.view'],
            'Petugas' => ['members.view', 'members.create', 'members.update', 'savings.view', 'savings.manage', 'loans.view', 'installments.manage'],
            'Anggota' => [],
        ];
